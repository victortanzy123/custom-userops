...
export interface ContractAccountFactoryInterface extends utils.Interface {
  functions: {
...
export interface ContractAccountFactory extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ContractAccountFactoryInterface;
