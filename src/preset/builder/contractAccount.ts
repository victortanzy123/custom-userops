...
import {
  ...
  ContractAccountFactory__factory,
  ContractAccount as ContractAccountImpl,
  ContractAccount__factory,
} from "../../typechain";
import { IPresetBuilderOpts, UserOperationMiddlewareFn } from "../../types";

export class ContractAccount extends UserOperationBuilder {
  private signer: ethers.Signer;
  private provider: ethers.providers.JsonRpcProvider;
  private entryPoint: EntryPoint;
  private factory: ContractAccountFactory;
  private initCode: string;
  proxy: ContractAccountImpl;
  ...
  private constructor(
    ...
    this.factory = ContractAccountFactory__factory.connect(
      opts?.factory || ERC4337.ContractAccount.Factory,
      this.provider
    );
    this.initCode = "0x";
    this.proxy = ContractAccount__factory.connect(
  ...
  public static async init(
    ...
    const instance = new ContractAccount(signer, rpcUrl, opts);
    ...
    try {
      ...
      instance.proxy = ContractAccount__factory.connect(addr, instance.provider);
    }
